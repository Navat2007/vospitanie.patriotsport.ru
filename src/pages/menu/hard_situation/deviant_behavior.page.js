...
const DeviantBehaviorPage = () => {

    const [tab, setTab] = React.useState(1);

    React.useEffect(() => {

        document.title = "Девиантное поведение";
        ...
        <div className="content__block">
            ...
            <div className="tab">
                <ul className="tab__list">
                    <li className={tab === 1 ? "tab__item --active" : "tab__item"} onClick={() => setTab(1)}>Раннее проблемное поведение</li>
                    <li className={tab === 2 ? "tab__item --active" : "tab__item"} onClick={() => setTab(2)}>Агрессивное поведение</li>
                    <li className={tab === 3 ? "tab__item --active" : "tab__item"} onClick={() => setTab(3)}>Делинквентное поведение</li>
                    <li className={tab === 4 ? "tab__item --active" : "tab__item"} onClick={() => setTab(4)}>Зависимое поведение</li>
                    <li className={tab === 5 ? "tab__item --active" : "tab__item"} onClick={() => setTab(5)}>Рискованное поведение</li>
                    <li className={tab === 6 ? "tab__item --active" : "tab__item"} onClick={() => setTab(6)}>Социально-психологическая дезадаптация</li>
                </ul>
...
export default DeviantBehaviorPage;