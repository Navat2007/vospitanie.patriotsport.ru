...
export default class SituationUsefulResourcesPage extends Component {
            ...
            <div className="content__block">
                ...
                <div className="tab">
                    <ul className="tab__list">
                        <li className={this.state.tab === 1 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(1)}>Для детей</li>
                        <li className={this.state.tab === 2 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(2)}>Для родителей</li>
                        <li className={this.state.tab === 3 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(3)}>Для педагогов</li>
                        <li className={this.state.tab === 4 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(4)}>Буллинг</li>
                        <li className={this.state.tab === 5 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(5)}>Полезная литература</li>
                    </ul>
