            ...
            <div className="content__block">
                ...
                <div className="tab">
                    <ul className="tab__list">
                        <li className={this.state.tab === 1 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(1)}>Церемония поднятия (спуска) государственного флага Российской Федерации</li>
                        <li className={this.state.tab === 2 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(2)}>&laquo;Разговоры о&nbsp;важном&raquo;</li>
                        <li className={this.state.tab === 3 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(3)}>Российское движение детей и&nbsp;молодежи</li>
                        <li className={this.state.tab === 4 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(4)}>Советник по&nbsp;воспитанию и&nbsp;взаимодействию с&nbsp;детскими общественными объединениями</li>
                        <li className={this.state.tab === 5 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(5)}>Историческое просвещение</li>
                        <li className={this.state.tab === 6 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(6)}>Школьный театр</li>
                        <li className={this.state.tab === 7 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(7)}>Школьные спортивные клубы</li>
                    </ul>
