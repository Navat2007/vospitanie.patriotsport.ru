...
export default class ProjectActivityPage extends Component {
            ...
            <div className="content__block">
                ...
                <div className="tab" style={{"marginTop": "1.875em"}}>
                    <ul className="tab__list">
                        <li className={this.state.tab === 1 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(1)}>Научно-практическая конференция на тему: «Непрерывное художественное образование в системе управления процессами воспитания и социализации». Ежегодная (XXIX-я) «Мастерская Б.М. Неменского»</li>
                        <li className={this.state.tab === 2 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(2)}>Открытая городская научно-практическая конференция «Курчатовский проект — от знаний к практике, от практики к результату» </li>
                        <li className={this.state.tab === 3 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(3)}>Открытая городская научно-практическая конференция «Старт в медицину»</li>
                        <li className={this.state.tab === 4 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(4)}>Открытая городская научно-практическая конференция «Наука для жизни»</li>
                        <li className={this.state.tab === 5 ? "tab__item --active" : "tab__item"} onClick={() => this.setTab(5)}>Открытая городская научно-практическая конференция «Инженеры будущего»</li>
                    </ul>
